...
EOD;
        ...
        while ($resultrow) {
            echo "Title:  ".htmlentities($resultrow['title'])."<BR>\n";
            echo "When:  ".htmlentities($resultrow['starttime'])."<BR>\n";
            echo "Duration:  ".htmlentities($resultrow['dur'])."<BR>\n";
            echo "Location:  ".htmlentities($resultrow['roomname'])."<BR>\n";
            echo "Description:  ".htmlentities($resultrow['description'])."<BR>\n";
            echo "Language:  ".htmlentities($resultrow['languagestatusname'])."<BR>\n";
            echo "Track:  ".htmlentities($resultrow['trackname'])."<BR>\n";
            echo "Moderator:  ".htmlentities($resultrow['moderator'])."<BR>\n";
            echo "All participants:  ".htmlentities($resultrow['parts'])."<BR>\n";
            echo "AV/Internet request:  ".htmlentities($resultrow['services'])."<BR>\n";
            echo "Session ID:  ".htmlentities($resultrow['sessionid'])."<BR>\n";
            echo "<BR>\n";
            $resultrow=mysql_fetch_array($result,MYSQL_ASSOC);
            }
