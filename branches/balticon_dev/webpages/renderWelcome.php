<?php
   ...
   getCongoData($badgeid);
    ...
    if (may_I('postcon')) { ?>
<P>Thank you for your participation in <?php echo(CON_NAME . " " . CON_ID);?>...  With your help it was a great con.  We look forward 
to your participation again next year.</P>
<P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-- <?php echo(CON_NAME); ?> Program Committee</P>
<?php
    participant_footer();
    exit();
    } ?>
