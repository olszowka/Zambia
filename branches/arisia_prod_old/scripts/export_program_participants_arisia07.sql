select concat('insert into CongoDump set badgeid="',m.master_rid,'";') ""
 ...
 where p.prop_rid=m.master_rid 
   ...
   and c.con_cid=18
   and (p.prop_name='db_ProgramStaff' 
        or p.prop_name='db_Program' 
        or p.prop_name='Z_EventStaff' 
        or p.prop_name='Z_EventGuest' )
   and p.prop_value=1
   ;
	 ...
	 where p.prop_rid=m.master_rid
   	   and c.con_cid=p.prop_cid
           ...
           and (p.prop_name='db_ProgramStaff' 
                ...
                or p.prop_name='Z_EventStaff' 
                or p.prop_name='Z_EventGuest' )
	   and p.prop_value=1 and c.con_cid=18) X, 
	reg_history h 
