<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="eventgridtimecolorreport.php";
    $title="Published Time Filled Color Event Grid";
    $description="<P>Display published event schedule with rooms on horizontal axis and regular time on vertical, keyed by color. This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
