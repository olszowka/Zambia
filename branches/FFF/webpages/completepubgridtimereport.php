<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="completepubgridtimereport.php";
    $title="Published Time Filled Grid";
    $description="<P>Display published schedule with rooms on horizontal axis and regular time on vertical. This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
