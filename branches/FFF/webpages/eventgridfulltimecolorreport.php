<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="eventgridfulltimecolorreport.php";
    $title="Unabridged Time Filled Color Event Grid";
    $description="<P>Display entire event schedule with rooms on horizontal axis and regular time on vertical, keyed by color. This includes all items marked \"Do Not Print\" or \"Staff Only\".</P>\n";
