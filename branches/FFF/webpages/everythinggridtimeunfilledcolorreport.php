<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="everythinggridtimeunfilledcolorreport.php";
    $title="Unabridged Time Semi-filled Color Complete Grid";
    $description="<P>Display complete schedule of all rooms with rooms on horizontal axis and regular time on vertical, keyed by color (only). This includes all items marked \"Do Not Print\" or \"Staff Only\".</P>\n";
