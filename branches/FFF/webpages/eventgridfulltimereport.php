<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="eventgridfulltimereport.php";
    $title="Unabridged Time Filled Event Grid";
    $description="<P>Display entire event schedule with rooms on horizontal axis and regular time on vertical. This includes all items marked \"Do Not Print\" or \"Staff Only\".</P>\n";
