...
EOD;
    ...
    renderhtmlreport($rows,$header_array,$report_array,0);
    renderhtmlreport($unrows,$unheader_array,$unreport_array,0);
    renderhtmlreport($fullrows,$fullheader_array,$fullreport_array,1);
