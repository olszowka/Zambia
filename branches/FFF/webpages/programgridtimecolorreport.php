<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="programgridtimecolorreport.php";
    $title="Published Time Filled Color Programming Grid";
    $description="<P>Display published grid of programming rooms with rooms on horizontal axis and regular time on vertical, keyed by color. This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
