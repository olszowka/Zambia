<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="eventgridfullreport.php";
    $title="Unabridged Event Grid";
    $description="<P>Display entire event schedule with rooms on horizontal axis and time on vertical. This includes all items marked \"Do Not Print\" or \"Staff Only\".</P>\n";
