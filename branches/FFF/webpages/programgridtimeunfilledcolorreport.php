<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="programgridtimeunfilledcolorreport.php";
    $title="Published Time Semi-filled Color Programming Grid";
    $description="<P>Display published grid of programming rooms with rooms on horizontal axis and regular time on vertical, keyed by color (only). This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
...
EOD;
	...
	$query.=" WHERE S.pubstatusid = 2 AND R.function like '%rogram%' AND";
