<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="eventgridfulltimeunfilledcolorreport.php";
    $title="Unabridged Time Semi-filled Color Event Grid";
    $description="<P>Display entire event schedule with rooms on horizontal axis and regular time on vertical, keyed by color (only). This includes all items marked \"Do Not Print\" or \"Staff Only\".</P>\n";
...
EOD;
	...
	$query.=" WHERE R.function like '%vent%' AND";
