<?php
    ...
    $title="Unabridged Color Complete Grid";
    $description="<P>Display complete schedule of all rooms with rooms on horizontal axis and time on vertical, keyed by color. This includes all items marked \"Do Not Print\" or \"Staff Only\".</P>\n";
