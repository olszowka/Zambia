<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="programgridcolorreport.php";
    $title="Published Color Programming Grid";
    $description="<P>Display published grid of programming rooms with rooms on horizontal axis and time on vertical, keyed by color. This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
...
EOD;
    ...
    $query.=" WHERE S.pubstatusid = 2 AND R.function like '%rogram%'";
