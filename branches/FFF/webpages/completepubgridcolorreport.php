<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="completepubgridcolorreport.php";
    $title="Published Color Grid";
    $description="<P>Display published schedule with rooms on horizontal axis and time on vertical, keyed by color. This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
