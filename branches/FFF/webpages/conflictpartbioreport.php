<?php
    ...
    function topofpage() {
        staff_header("Conflict Report - Participant Bio in conflict");
        date_default_timezone_set('US/Eastern');
        echo "<P align=center> Generated: ".date("D M j G:i:s T Y")."</P>\n";
        echo "<P>Show the badgeid, pubsname and both bio entries for each participant who indicated he is attending.</P>\n";
        }
