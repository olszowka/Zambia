<?php
    ...
    $title="Published Time Filled Color Grid";
    $description="<P>Display published schedule with rooms on horizontal axis and regular time on vertical, keyed by color. This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
