<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="everythinggridtimereport.php";
    $title="Unabridged Time Filled Complete Grid";
    $description="<P>Display complete schedule of all rooms with rooms on horizontal axis and regular time on vertical. This includes all items marked \"Do Not Print\" or \"Staff Only\".</P>\n";
