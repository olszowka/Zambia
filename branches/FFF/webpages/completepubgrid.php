<?php
    ...
    $description="<P>Display published schedule with rooms on horizontal axis and time on vertical. This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
