<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="fasttrackgridstaticreport.php";
    $title="Fast Track Grid";
    $description="<P>Grid of all fast track sessions as determined by function of room</P>\n";
    ...
    $indicies="FASTTRACKWANTS=1, GRIDWANTS=1";
