<?php
    ...
    ## LOCALIZATIONS
    $_SESSION['return_to_page']="programgridtimereport.php";
    $title="Published Time Filled Programming Grid";
    $description="<P>Display published grid of programming rooms with rooms on horizontal axis and regular time on vertical. This excludes any item marked \"Do Not Print\" or \"Staff Only\".</P>\n";
