...
EOD;
    ...
    echo " to this schedule please contact <A HREF=\"mailto:program@arisia.org\">program@arisia.org</A>.\n";
    ...
    echo "<P>You're registration status is <SPAN class=\"hilit\">$regmessage.</SPAN>\n";
    echo "<P>Thank you -- <A HREF=\"mailto: program@arisia.org\"> Programming </a>\n";
    echo "    <TABLE>\n";
