...
<table>
  <COL><COL>
   ...
   <tr><td>Used for creating new sessions.  They are intially created in status "edit me".  Once created, a second persion edits for content (and uniquness). This person promts the sssion to status "Brainstorm".  A third set of eyes does a basic grammar and spelling edit and promotes the session to status "Vetted".   At that time it is ready for general viewing by prospective panelists. 
   ...
   <tr><td>Since the purpose of the Precis is to get participants to signup to be on various panels or to help with various events, this report contains sessions where that status is brainstom or vetted.  Note that sessions marked invited guest only are not included in the precis (regardless of status).
</table>
