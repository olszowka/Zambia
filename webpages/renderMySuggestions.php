...
function renderMySuggestions($title, $error, $message, $paneltopics, $otherideas, $suggestedguests) {
    ...
    echo "<div class=\"container-xxxl mt-2\">";
    if ($error) {
    ...
    echo "<div class=\"titledtextarea form-group mt-4\">\n";
    echo "    <label for=\"paneltopics\">Program Topic Ideas:</label>\n";
    echo "    <textarea class=\"form-control mt-2\" name=\"paneltopics\" rows=\"6\" cols=\"72\"";
    if (!may_I('my_suggestions_write')) {
    ...
    echo "    <textarea class=\"form-control mt-2\" name=\"otherideas\" rows=\"6\" cols=\"72\"";
    if (!may_I('my_suggestions_write')) {
        echo " readonly class=\"readonly\"";
    }
    ...
    echo "    <textarea class=\"form-control mt-2\" name=\"suggestedguests\" rows=\"8\" cols=\"72\"";
    if (!may_I('my_suggestions_write')) {
        echo " readonly class=\"readonly\"";
    }
    ...
    echo "    </div>\n";
    if (may_I('my_suggestions_write')) {
        echo "<div id=\"submit\" class=\"mt-4\"><button class=\"SubmitButton btn btn-primary\" type=\"submit\" name=\"submit\">Save</button></div>\n";
    }
    echo "</form>\n";
    echo "</div>\n";
    echo "</div>\n";
