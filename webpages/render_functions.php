...
function RenderPrecis($result, $showlinks) {
    ...
    while (list($sessionid, $trackname, $typename, $title, $duration, $estatten, $progguiddesc, $persppartinfo, $starttime, $roomname, $statusname, $taglist)
        ...
        $show_taglist = "";
        if ($taglist !== null) {
            $show_taglist = htmlspecialchars($taglist, ENT_NOQUOTES);
        }
        $show_guide = "";
        if ($progguiddesc !== null) {
            $show_guide = htmlspecialchars($progguiddesc, ENT_NOQUOTES);
        }
        echo "    <td colspan=\"2\" class=\"border0010\">" . $show_taglist . "</td>";
        echo "    <td colspan=\"6\" class=\"border0010\">" . $show_guide . "</td>";
        echo "</tr>\n";
        if ($persppartinfo) {
            echo "<tr><td></td>";
