...
EOD;
        ...
        $sessionNode -> setAttribute('secondtitle',  is_null($session['secondtitle']) ? '' :  $session['secondtitle']);
        $sessionNode -> setAttribute('pocketprogtext',  is_null($session['pocketprogtext']) ? '' :  $session['pocketprogtext']);
        ...
        $sessionNode -> setAttribute('persppartinfo', is_null($session['persppartinfo']) ? '' : $session['persppartinfo']);
        $sessionNode -> setAttribute('notesforpart', is_null($session['notesforpart']) ? '' : $session['notesforpart']);
        $sessionNode -> setAttribute('servnotes', is_null($session['servnotes']) ? '' : $session['servnotes']);
        $sessionNode -> setAttribute('notesforprog', is_null($session['notesforprog']) ? '' : $session['notesforprog']);
