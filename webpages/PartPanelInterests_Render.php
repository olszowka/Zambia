...
function render_session_interests($badgid,$session_interest_count,$message,$message_error) {
    ...
    for ($i=1; $i<=$session_interest_count; $i++) {
        ...
        echo "            <INPUT type=\"hidden\" name=\"sessionid$i\" value=\"{$session_interests[$i]['sessionid']}\"></TD>\n";
        ...
        echo "        </TR>\n";
        echo "    <TR>\n";
        echo "        <TD class=\"border0000 usrinp\">Rank: <INPUT type=\"text\" size=3 name=\"rank$i\" value=\"{$session_interests[$i]['rank']}\"></TD>\n";
        echo "        <TD class=\"border0000 usrinp\">I'd like to moderate this panel:<INPUT type=\"checkbox\" value=1 name=\"mod$i\" ";
        ...
        echo "            <TEXTAREA height=5em cols=80 name=\"comments$i\" id=\"intCmnt\">". htmlspecialchars( $session_interests[$i]['comments'],ENT_COMPAT)."</TEXTAREA></TD>\n";
        echo "        </TR>\n";
        echo "    <TR>\n";
