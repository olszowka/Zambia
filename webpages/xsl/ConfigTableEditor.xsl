        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade show mt-4" id="part">
            ...
            <ul class="nav nav-tabs">
              ...
              <xsl:if test="/doc/query[@queryname='permission_set']/row[@permatomtag='ce_PhotoDenialReasons']">
                <li class="nav-item">
                  <a href="#photodenialreasons" class="nav-link" data-toggle="tab" data-top="part-top" id="t-PhotoDenialReasons">PhotoDenialReasons</a>
                </li>
              </xsl:if>
            </ul>
            <div class="tab-content">
              <div class="tab-pane mt-4 fade show active" id="partdesc">
                ...
                <ul>
                  ...
                  <xsl:if test="/doc/query[@queryname='permission_set']/row[@permatomtag='ce_PhotoDenialReasons']">
                    ...
                    <p>"List of reasons a participant photo could be denied public status</p>
                  </xsl:if>
                </ul>
              </div>
              <xsl:if test="/doc/query[@queryname='permission_set']/row[@permatomtag='ce_BioEditStatuses']">
