        ...
        <nav id="staffNav" class="navbar navbar-inverse">
            <div class="navbar-inner">
                <div class="container" style="width: auto;">
                    ...
                    <span class="brand inactive" ><xsl:value-of select="$title" /></span>
                    <div class="nav-collapse">
                        <ul class="nav">
                            <li class="dropdown">
                                <a href="#sessions" class="dropdown-toggle" data-toggle="dropdown">Sessions<b class="caret" /></a>
                            ...
                            <li class="dropdown">
                                <a href="#participants" class="dropdown-toggle" data-toggle="dropdown">Participants<b class="caret" /></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <xsl:if test="/doc/query[@queryname='permission_set']/row[@permatomtag='SendEmail']">
                                        <li><a href="StaffSendEmailCompose.php">Send email</a></li>
                                    </xsl:if>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Reports<b class="caret" /></a>
                                <ul class="dropdown-menu">
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            <li><div class='menu-error-entry'>Report menus not built!</div></li>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                    <li class='divider' />
                            ...
                            <li class="dropdown">
                                <a href="#scheduling" class="dropdown-toggle" data-toggle="dropdown">Scheduling<b class="caret" /></a>
                                <ul class="dropdown-menu">
