...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="ConfigurePermissions"
        select="/doc/query[@queryname='permission_set']/row[@permatomtag='ConfigurePermissions']"/>
    <xsl:variable name="Administrator"
        select="/doc/query[@queryname='permission_set']/row[@permatomtag='Administrator']"/>
    <xsl:variable name="Brainstorm"
        select="/doc/query[@queryname='permission_set']/row[@permatomtag='BrainstormSubmit']"/>
    <xsl:template match="/">
