...
function applyXsltStylesheet($xml, $stylesheet) {
    $xsl = new DomDocument;
...
function writeHtmlToOutput($xml, $stylesheet) {
    $html = applyXsltStylesheet($xml, $stylesheet);
...
writeHtmlToOutput($xml, $stylesheet);
?>
