            ...
            <div class="card-body">
                ...
                <form name="pwform" method=POST action="SubmitWelcome.php">
                    <div id="update_section" class="form-group mb-2 row">
                        <label for="interested" class="col-sm-3">Are you interested?</label>
                        <?php $int=$participant_array['interested']; ?>
                        <select id="interested" name="interested" class="form-control col-sm-3">
                    ...
                    <div class="form-group mb-2 row">
                        ...
                        <input id="password" class="form-control col-sm-3" type="password" size="10" name="password" />
                    </div>
                    <div class="form-group mb-2 row">
                        <label class="col-sm-3" for="cpassword">Confirm New Password:</label>
                        <input id="cpassword" class="form-control col-sm-3" type="password" size="10" name="cpassword" />
                    </div>
                    <?php } ?>
                    <div class="row">
